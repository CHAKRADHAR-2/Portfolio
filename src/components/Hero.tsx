      ...
      >
        ...
        >
          <div className="relative w-48 h-48 mx-auto">
            {/* 3D Rotating Frame */}
            <div className="absolute inset-0 rounded-full border-2 border-portfolio-primary/30 animate-rotate-3d" style={{ animationDuration: '20s' }} />
            <div className="absolute inset-2 rounded-full border-2 border-portfolio-secondary/30 animate-rotate-3d" style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
            <div className="absolute inset-4 rounded-full border-2 border-portfolio-accent/30 animate-rotate-3d" style={{ animationDuration: '25s' }} />
            
            {/* Profile Image */}
            <div className="relative w-full h-full rounded-full overflow-hidden elegant-border hover-lift">
              <img 
                src="https://res.cloudinary.com/dupmwyyzt/image/upload/v1756259786/formal_mjk9rx.jpg" 
            ...
            {/* Pulse Effect */}
            <div className="absolute inset-0 rounded-full bg-portfolio-primary/20 animate-pulse" />
          </div>
        </motion.div>
