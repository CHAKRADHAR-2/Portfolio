...
import { Code, Monitor, Palette, Database, Globe, Zap, Sparkles, ArrowRight } from 'lucide-react';
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Modern, responsive frontend applications using React, Vue.js, and Angular. Interactive user interfaces with seamless user experience.",
      features: ["React & Vue.js", "Responsive Design", "Interactive UI/UX", "Modern JavaScript"],
    ...
    },
    {
      ...
      description: "Seamless API integrations and efficient data handling solutions for modern web applications and databases.",
      features: ["RESTful API Integration", "Database Optimization", "Data Migration", "Third-party Services"],
